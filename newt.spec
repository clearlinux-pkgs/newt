...
Source0  : https://releases.pagure.org/newt/newt-0.52.23.tar.gz
...
%prep
%setup -q -n newt-0.52.23
cd %{_builddir}/newt-0.52.23
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670536530
